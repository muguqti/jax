...
bazel_packages = {
    ...
    # TODO: Update SHA256 once bazel-8.7.0-windows-arm64.exe is verified.
    # Obtain via: curl -sL https://github.com/bazelbuild/bazel/releases/download/8.7.0/bazel-8.7.0-windows-arm64.exe.sha256
    # In CI, prefer using bazelisk (choco install bazelisk) which auto-downloads
    # the correct Bazel binary and bypasses this SHA256 check.
    ("Windows", "ARM64"): BazelPackage(
        base_uri=None,
        file="bazel-8.7.0-windows-arm64.exe",
        sha256=(
            "TODO_REPLACE_WITH_REAL_SHA256_FOR_BAZEL_8_7_0_WINDOWS_ARM64"
        ),
    ),
}
